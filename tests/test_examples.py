...
class TestEncoder:
    ...
    def test_students_missing(self):
        ...
        one = [s1_anon, s2_anon]
        two = [s2_anon, s1_anon]
        actual = JsonSerializer(Student, allow_missing=True).load_many('[{"id": 1}, {"id": 2}]')
